...
<div id="fh5co-main-content">
	...
	<div id="fh5co-footer">
		<div class="row">
			<div class="col-md-6">
			<?php
                if (is_active_sidebar ("launcher_footer_left")){
                    dynamic_sidebar ("launcher_footer_left");
                }
            ?>
			</div>
			<div class="col-md-6 fh5co-copyright">
			    <?php
                    if (is_active_sidebar ("launcher_footer_right")){
                        dynamic_sidebar ("launcher_footer_right");
                    }
                ?>
			</div>
		</div>
